...
const Form = () => {
  ...
  function handleSubmit(event) {
    ...
    if (titleError || summaryError || hsError || imgError)
      alert("Check the format of your submission.");
    else {
  ...
  const handleChange = (event) => {
    ...
    if (/(http)?s?:?(\/\/[^"']*\.(?:png|jpg|jpeg|png))/.test(form.image))
      setImgError(false);
    else setImgError(true);
      ...
      <form className="container-form">
        <ul className="text-form">
          ...
          <li>
            ...
            {imgError ? (
              <p className="error">
                Must be a valid url. Allowed formats are png, jpg, jpeg
              </p>
            ) : null}
          </li>
        </ul>
