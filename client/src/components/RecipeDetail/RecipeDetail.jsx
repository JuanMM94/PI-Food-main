  ...
  return (
    <>
      ...
      <div className="container-recipedetail" key={recipes.id}>
        ...
        <p className="detail-healthscore">
          Health Score <sup>{recipes.healthScore}</sup>
        </p>
        ...
        <p className="detail-step">
          {typeof recipes.analyzedInstructions !== "undefined" &&
        ...
        <button className="detail-button" onClick={() => history.goBack()}>
          Back
        </button>
      </div>
    </>
